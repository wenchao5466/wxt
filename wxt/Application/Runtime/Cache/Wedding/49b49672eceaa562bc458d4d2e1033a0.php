	...
	<div class="index box">
		<table class="row100 index_cent">
			...
			<tr>
				...
				<td rowspan='2'><img src="/public/Wedding/img/index_img8.jpg" alt=""><div class="mytxt section2"><?php echo $userpost['city']?></div></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan='2'>
					...
					<div class="section3" id="section3">
						<div id="preview" class="section3a" style="">
						<?php echo $userpost['photo']?>
