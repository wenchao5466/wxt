...
<script>
	...
	function del(v,id)
	{
		...
		sd=true;
		$.post("/wxt/member/msg/del",{'id':id,'type':'ajax'},function(data){
			if(data.status>0)
			{
...
<td width="20px"></td><td><a href="/wxt/member/person/glist"   >嘉宾</a></td>
<td width="20px"></td><td><a href="/wxt/member/msg/glist"  style="font-weight:bold" >留言</a></td>
  ...
  <div id="content01">
    <table id="mscenter01" cellpadding="10" cellspacing="6" bgcolor="#CCCCCC" width="800px">
      <tr>
        <td bgcolor="#FFFFFF" align="center">查看祝福留言<span style="color:red"></span></td>
      </tr>
      <tr>
        <td bgcolor="#ffffff" align="center">
            <table cellpadding="6" cellspacing="0"  >
                 ...
                 <tr>
                               ...
                               <td width="20%" align="center" style="border-bottom:dashed 1px #ccc"><?php echo $mssage['id']?></td>
                               <td width="20%" align="center" style="border-bottom:dashed 1px #ccc"><?php echo $mssage['name']?></td>
                               <td style="border-bottom:dashed 1px #ccc"><?php echo $mssage['description']?></td>
                               <td width="5%" style="border-bottom:dashed 1px #ccc"><a style="cursor:pointer" onClick="del(0,<?php echo $mssage['id']?>)">删</a></td>
                 </tr>
                 <?php endforeach;?>
