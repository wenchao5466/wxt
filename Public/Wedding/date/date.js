    ...
    function resetIndex(){
        ...
        function bindButton(){
            ...
            $("#datecancle").click(function () {
                $("#datePage").hide();
                $('.bod_cent').css({'height':'auto','overflow':'auto'})
        $("#dateshadow").hide();
                // Ncallback(false);
            });
        }       
        ...
        function init_iScrll() {
            $('.bod_cent').css({'height':'100%','overflow':'hidden'})
            // alert($("#yearwrapper ul li:eq("+indexY+")").text())
            var strY = $("#yearwrapper ul li:eq("+indexY+")").text().substr(0,$("#yearwrapper ul li:eq("+indexY+")").text().length-1);
            var strM = $("#monthwrapper ul li:eq("+indexM+")").text().substr(0,$("#monthwrapper ul li:eq("+indexM+")").text().length-1)
