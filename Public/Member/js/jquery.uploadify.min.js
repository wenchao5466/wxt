        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    uploadLimit: 8,                  // The maximum number of files you can upload
                ...
                switch (errorCode) {
                    case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                        if (settings.queueSizeLimit > errorMsg) {
                            this.queueData.errorMsg += '\抱歉您一次最多上传 (' + errorMsg + ')个文件！.';
                        } else {
        ...
        onUploadSuccess: function (file, data, response) {
			...
			try{
			  dt3 = eval('(' + data + ')');  
				...
				$('#' + file.id).find('.data').html(' - <span style=\'color:red\'>系统错误</span>');
				return ;
			}
			
			if(dt3.status<0)
			{
				$('#' + file.id).find('.data').html(' - <span style=\'color:red\'>'+dt3.msg+'</span>');
